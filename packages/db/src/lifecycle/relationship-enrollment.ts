...
// fill_discount/fill_repair (Phase 26 S5): fill plays send on the same rail.
export const CADENCE_TEXT_PROGRAMS = ["checkin_30d", "roofiversary", "move_play", "fill_discount", "fill_repair", "maintenance_offer", "maintenance_renewal", "maintenance_winback"] as const;
