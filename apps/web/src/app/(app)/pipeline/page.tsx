...
import { getVelocity, getRepPerformance, getRaceMetrics } from "@/lib/dashboard-queries";
...
export default async function PipelinePage() {
  const [data, velocity, repPerf, race] = await Promise.all([getPipelineBoard(), getVelocity(), getRepPerformance(), getRaceMetrics()]);
  return (
    <div className="space-y-4" data-testid="pipeline-page">
      ...
      <PipelineMetrics velocity={velocity} repPerf={repPerf} race={race} />
    </div>
  );
}
